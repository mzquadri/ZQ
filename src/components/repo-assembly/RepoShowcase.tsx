 ...
 * field it came from, the repository it belongs to, and its last public commit. The
 * canvas is an additional band above it, not a replacement for it, so nothing is hidden
          ...
          <li className={styles.card} key={assembly.name}>
            ...
            <div className={styles.cardFoot}>
              <p className={styles.updated}>
                Last public commit{" "}
                <time dateTime={assembly.lastCommit}>{assembly.lastCommit}</time>
              </p>
