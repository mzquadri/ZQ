 ...
 * rasteriser, and the section actually on screen. Until then the exploded schematic is the page
 * - a complete figure, not a placeholder - so the renderer buys depth rather than meaning.
 *
