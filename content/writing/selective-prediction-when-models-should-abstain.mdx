...
The quantitative example and its limitations come from the [canonical thesis repository](https://github.com/mzquadri/ml_surrogates_for_agent_based_transport_models). The [research experience](/research/thesis) places this decision rule inside the wider GNN, calibration, and conformal-prediction study. The selective-classification framing follows Geifman and El-Yaniv's [selective classification work](https://arxiv.org/abs/1705.08500).
