...
In my transport-surrogate research, the reviewed MC Dropout archive covered 100 held-out scenarios and 3,163,500 road-link predictions. Three reported operating points were:
...
The quantitative example and its limitations come from the [canonical thesis repository](https://github.com/mzquadri/ml-surrogates-thesis). The selective-classification framing follows Geifman and El-Yaniv's [selective classification work](https://arxiv.org/abs/1705.08500).
