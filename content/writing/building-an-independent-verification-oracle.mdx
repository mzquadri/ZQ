...
4. **Different text assembly.** How character data is gathered — including what happens to text between and after child elements — is a classic source of quiet disagreement, so the two sides should do it differently on purpose.
