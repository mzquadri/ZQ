...
<Callout title="Identifiers that cannot drift">
...
This catches partial writes, silent client-side batching failures, and the whole class of "it looked like it worked". Keep it.
...
## The consumer side, and the theory
