...
Identified during Website Completion v1. This document **identifies** future work. It does not
authorise creating repositories, and nothing here has been created, forked, or archived.
...
| 2 | MLOps | `MLOps-End-to-End-Pipeline` is a tested reference with a synthetic fallback. | **Extend.** A reproducible licensed-data run with a published bundle and a container integration test. |
